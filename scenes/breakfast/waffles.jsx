...
addScenes({
    ...
    make_waffles: {
        prompt: () => <div>
            ...
            <p>The grocery store has new Waffle brands: <Color color="lime">Lucky Charms</Color> and <Color color="cornflowerblue">Frosted Flakes</Color></p>
        </div>,
        options: [
    ...
    waffles_charms: {
        prompt: () => <div>
            <p>Right as you start grabbing the Lucky Charms waffle mix, Frosted Flakes decides to place out an advertisement on the new Frosted Waffles 
                that they have with 30% less fat and 24% more frosting. <strong>Are you sure you want the Lucky Charms.</strong>
            </p>
        </div>,
        options: [
    ...
    waffles_frosted: {
        prompt: () => <div>
            <p>Right as you start grabbing the Frosted Flakes waffle mix, Lucky Charms decides to place out an advertisement on the new Lucky Waffles 
                that they have with 50% less fat and 60% more luck. <strong>Are you sure you want the Frosted Flakes.</strong>
            </p>
        </div>,
        options: [
    ...
    waffles_charms2: {
        prompt: () => <div>
            <p>Frosted Flakes has a new advertisement on the unluckiness of Lucky Charms, and how it curses you with infinite unluck. <strong>Are 
                you sure you want the Lucky Charms.</strong>
            </p>
        </div>,
        options: [
    ...
    waffles_frosted_from_charms1: {
        prompt: () => <div>
            <p>You decide to change to Frosted Flakes, but then another advertisement appears about the Health Risks of the Frosting that Frosted Flakes uses. <strong>Are you sure you want the Frosted Flakes.</strong></p>
        </div>,
        options: [
    ...
    waffles_frosted_from_charms2: {
        prompt: () => <div>
            <p>You decide to change to Frosted Flakes, but then another advertisement appears about the Expensive Price that Frosted Flakes has. <strong>Are you sure you want the Frosted Flakes.</strong></p>
        </div>,
        options: [
    ...
    waffles_frosted_from_charms3: {
        prompt: () => <div>
            <p>The CEO of Google emails you about how the world is going to die if you choose the Frosted Flakes. <strong>Are you sure you want the 
                Frosted Flakes.</strong>
            </p>
        </div>,
        options: [
    ...
    waffles_charms_from_frosted1: {
        prompt: () => <div>
            <p>You switch to Lucky Charms, but then you get a advertisement about. <strong>Are you sure you want the Frosted Flakes.</strong></p>
        </div>,
        options: [
            { text: "Lucky Charms", to: "waffles_charms_from_frosted2" },
            { text: "Frosted Flakes", to: "waffles_frosted_from_charms2" },
    ...
    waffles_charms_from_frosted2: {
        prompt: () => <div>
            <p>You decide to change to Lucky Charms, but then they advertise the buy one get 50 free sale that Frosted Flakes are doing. <strong>Are you 
                sure you want the Lucky Charms.</strong>
            </p>
        </div>,
        options: [
            { text: "Lucky Charms", to: "waffles_charms_from_frosted3" },
    ...
    waffles_charms_from_frosted3: {
        prompt: () => <div>
            <p>The CEO of Google emails you about how the world is going to die if you choose the Lucky Charms. <strong>Are you sure you want the 
                Lucky Charms.</strong>
            </p>
        </div>,
        options: [
    ...
    waffles_wait13: {
        prompt: () => <div style={{position: "relative"}}>
            <p>You <span style={{visibility: "hidden"}}>Wait</span> for the waffles to cook...</p>
            <SceneLink style={{
                display: "block",
                position: "absolute",
                color: "white",
    ...
    waffles_wait_done: {
        prompt: () => <div>
            <p>You Wait for the waffles to cook... and they are done now!</p>
        </div>,
        options: [
    ...
    eat_waffle_ending: {
        prompt: () => <div>
            <p>You have created the best waffle there has ever been, and won the award winning prize for best waffle, but because you ate the waffle 
